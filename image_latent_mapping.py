...
if __name__ == '__main__':
    ...
    img_filepath = 'third_party/Natural-Color-Fool/dataset/images'
    ...
    for i in trange(image_nums):
        ...
        start = time.time()
        # Image Inversion
        (image_gt, image_enc), x_t, uncond_embeddings = null_inversion.invert(img_path, prompts[0], offsets=(0,0,0,0), verbose=True)
        ...
        ptp_utils.view_images([image_gt, image_inv[0]], prefix='1000/pair/%d' % (idx))
        ptp_utils.view_images([image_gt], prefix='1000/original/%d' % (idx))
        ptp_utils.view_images([image_inv[0]], prefix='1000/inversion/%d' % (idx))


    torch.save(all_latents, 'temp/1000/all_latents.pth')
    torch.save(all_uncons, 'temp/1000/all_uncons.pth')